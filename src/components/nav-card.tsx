...
import MediaFilledSVG from '@/svgs/media-filled.svg'
import MediaOutlineSVG from '@/svgs/media-outline.svg'
...
import { SnowDecoration, useChristmasEnabled } from '@/components/snow-decoration'
...
const list = [
	...
	{
		icon: MediaOutlineSVG,
		iconActive: MediaFilledSVG,
		label: '影音空间',
		href: '/media'
	},
	{
		...
		return (
			<HomeDraggableLayer cardKey='navCard' x={position.x} y={position.y} width={styles.width} height={styles.height}>
				<Card
					...
					{form === 'full' && <SnowDecoration preset="navCard" />}

					<Link className='flex shrink-0 items-center gap-3' href='/'>
						<Image src='/images/avatar.png' alt='avatar' width={40} height={40} style={{ boxShadow: ' 0 12px 20px -5px #E2D9CE' }} className='shrink-0 rounded-full' />
